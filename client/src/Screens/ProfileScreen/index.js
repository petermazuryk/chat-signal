...
const ProfileScreen = () => {
  ...
  return Auth?.auth ? (
    <View>
      ...
      <Input label={"Your Name"} value={"Peter"} disabled={edit} />
      <Input label={"Your Email"} value={"m@gmail.com"} disabled={edit} />
      <Input label={"Your Phone"} value={"123456"} disabled={edit} />
      ...
      <View style={{ alignSelf: "center" }}>
        <Button
          ...
          containerStyle={{ width: "40%", borderRadius: 30, padding: 10 }}
          title="logout"
        />
      </View>
    </View>
